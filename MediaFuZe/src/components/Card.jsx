...
function Card({ item }) {
  ...
  return (
    ...
    <Link to={`/details/${item.type}/${item.id}`}>
      <div className="card-gradd rounded-xl overflow-hidden hover:scale-105 transition-transform hover:shadow-lg hover:shadow-black/50 duration-300 cursor-pointer w-full h-80">
