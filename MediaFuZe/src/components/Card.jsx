...
function Card({ item }) {
  ...
  return (
    ...
    <Link to={`/details/${item.type}/${item.id}`}>
      <div className="bg-linear-to-r from-fuchsia-900 to-pink-700 rounded-xl overflow-hidden hover:scale-105 transition-transform hover:shadow-lg hover:shadow-black/50 duration-300 cursor-pointer w-full h-80">
